...
/*71*/ {8, 0, 2, 8, 2, 5, 8, 7, 5, 10, 2, 5},
/*72*/ {10, 5, 6, 11, 3, 2},
/*73*/ {0, 4, 1, 4, 5, 1, 2, 11, 3},
/*74*/ {9, 0, 1, 10, 6, 5, 2, 11, 3},
...
/*88*/ {10, 6, 5, 9, 0, 1, 4, 8, 7},
/*89*/ {11, 3, 6, 3, 6, 0, 10, 1, 2, 6, 4, 0},
/*90*/ {0, 3, 8, 1, 2, 10, 4, 5, 9, 6, 7, 11},
/*91*/ {1, 2, 10, 5, 4, 9, 6, 7, 11},
...
/*116*/ {1, 2, 6, 1, 6, 8, 1, 9, 8, 7, 6, 8},
/*117*/ {11, 8, 2, 8, 0, 2, 10, 5, 6},
/*118*/ {8, 7, 0, 7, 0, 6, 0, 2, 6},
/*119*/ {1, 5, 2, 5, 6, 2},
/*120*/ {6, 7, 10, 7, 10, 8, 2, 3, 11, 10, 9, 8},
/*121*/ {2, 0, 10, 0, 9, 10, 6, 7, 11},
/*122*/ {5, 4, 9, 1, 2, 10, 0, 3, 8},
/*123*/ {2, 1, 10, 6, 7, 11},
...
/*132*/ {2, 1, 10, 6, 7, 11},
/*133*/ {5, 4, 9, 1, 2, 10, 0, 3, 8},
/*134*/ {2, 0, 10, 0, 9, 10, 6, 7, 11},
/*135*/ {6, 7, 10, 7, 10, 8, 2, 3, 11, 10, 9, 8},
/*136*/ {1, 5, 2, 5, 6, 2},
/*137*/ {8, 7, 0, 7, 0, 6, 0, 2, 6},
/*138*/ {11, 8, 2, 8, 0, 2, 10, 5, 6},
/*139*/ {1, 2, 6, 1, 6, 8, 1, 9, 8, 7, 6, 8},
...
/*164*/ {1, 2, 10, 5, 4, 9, 6, 7, 11},
/*165*/ {0, 3, 8, 1, 2, 10, 4, 5, 9, 6, 7, 11},
/*166*/ {11, 3, 6, 3, 6, 0, 10, 1, 2, 6, 4, 0},
/*167*/ {10, 6, 5, 9, 0, 1, 4, 8, 7},
...
/*181*/ {9, 0, 1, 10, 6, 5, 2, 11, 3},
/*182*/ {0, 4, 1, 4, 5, 1, 2, 11, 3},
/*183*/ {10, 5, 6, 11, 3, 2},
/*184*/ {8, 0, 2, 8, 2, 5, 8, 7, 5, 10, 2, 5},
